...
export const updateDoctorsData = async (doctors, updatedDoctor = null) => {
    let doctorsDataJSON;
    if (!updatedDoctor) {
    ...
    await fs.writeFile(doctorsConstants.paths.DATA_PATH, doctorsDataJSON, { encoding: 'utf-8' }).catch(err => {
